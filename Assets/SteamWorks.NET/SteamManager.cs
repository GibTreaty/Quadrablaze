...
public class SteamManager : MonoBehaviour {
    ...
    public bool UseSteamManager {
        get { return _useSteamManager; }
    }
    ...
    private void Awake() {
        ...
        try {
            ...
            if(SteamAPI.RestartAppIfNecessary((AppId_t)661050)) {
                Application.Quit();
                return;
            }
#endif
    ...
    public bool Initialize() {
        if(!UseSteamManager) return false;
