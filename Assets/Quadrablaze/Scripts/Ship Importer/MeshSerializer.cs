...
public class MeshSerializer {
    ...
    public static Mesh ReadMesh(byte[] bytes) {
        ...
        if((format & 16) != 0) {
            ...
            ReadColor32ArrayBytes(colors, buf);
    ...
    public static byte[] WriteMesh(Mesh mesh, bool saveTangents) {
        ...
        WriteColor32ArrayBytes(colors, buf);
    ...
    static void ReadColor32ArrayBytes(Color32[] arr, BinaryReader buf) {
    ...
    static void WriteColor32ArrayBytes(Color32[] arr, BinaryWriter buf) {
        if(arr.Length == 0)
            return;
