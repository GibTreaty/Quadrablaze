...
////// Emissive:
                ...
                float3 emissive = lerp((_MetallicColor.rgb*pow(max(0,dot(halfDirection,i.normalDir)),exp2(_MetallicPower))),(node_9750*_GlowColor.rgb),node_9750);
/// Final Color:
