...
Shader "Instanced/Animated Vertex Color Map Instanced" {
	Properties{
		...
		[HDR]_GlowColorHigh("GlowColorHigh", Color) = (1,1,1,1)
		_AnimateSpeed("AnimateSpeed", Float) = 1
...
#define _AccessorySecondaryColor_arr Props
		...
		void surf(Input IN, inout SurfaceOutputStandard o) {
			...
			fixed time = (sin(_Time.y * 3.145 * _AnimateSpeed * 2).r + 1) * .5;
			...
			float3 emissive = IN.vertexColor.g * lerp(_GlowColor.rgb, _GlowColorHigh.rgb, time);
