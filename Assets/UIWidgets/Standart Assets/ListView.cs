	...
	public class ListView : ListViewBase
	{
		...
		public override void Start()
		{
			...
			if (CanOptimize())
			{
				...
				{
					LayoutBridge = new EasyLayoutBridge(layout as EasyLayoutNamespace.EasyLayout, DefaultItem.transform as RectTransform);
					LayoutBridge.IsHorizontal = IsHorizontal();
				}
		...
		{
			return scrollRect!=null && (layout!=null || Container.GetComponent<EasyLayoutNamespace.EasyLayout>()!=null);
		}
