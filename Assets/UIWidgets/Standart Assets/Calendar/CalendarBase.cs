	...
	public abstract class CalendarBase : MonoBehaviour
	{
		...
		public EasyLayoutNamespace.EasyLayout Layout {
			get {
				if (layout==null)
				{
					layout = Container.GetComponent<EasyLayoutNamespace.EasyLayout>();
				}
				return layout;
			}
		}
		...
		protected virtual void Init()
		{
			...
			Layout.LayoutType = EasyLayoutNamespace.LayoutTypes.Grid;
			Layout.Stacking = EasyLayoutNamespace.Stackings.Horizontal;
			Layout.GridConstraint = EasyLayoutNamespace.GridConstraints.FixedColumnCount;
