...
namespace EasyLayoutNamespace
{
	...
	public class EasyLayoutResizer
	{
		...
		static SizesInfo GetWidths(List<List<LayoutElementInfo>> elems)
		{
			...
			{
				sizes[i] = new Sizes(){
					Min = elems[i].Max<LayoutElementInfo,float>(x => x.MinWidth),
					Preferred = elems[i].Max<LayoutElementInfo,float>(x => x.PreferredWidth),
					Flexible = elems[i].Max<LayoutElementInfo,float>(x => x.FlexibleWidth),
				};
			}
			return GetSizesInfo(sizes);
		}
		...
		static SizesInfo GetHeights(List<List<LayoutElementInfo>> elems)
		{
			...
			{
				sizes[i] = new Sizes(){
					Min = elems[i].Max<LayoutElementInfo,float>(x => x.MinHeight),
					Preferred = elems[i].Max<LayoutElementInfo,float>(x => x.PreferredHeight),
					Flexible = elems[i].Max<LayoutElementInfo,float>(x => x.FlexibleHeight),
				};
			}
			return GetSizesInfo(sizes);
		}
